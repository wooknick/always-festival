...
export const stageB = [
  ...
  {
    artist: "Beyoncé",
    video_id: "YnhT5sZnvXM",
    comments: [
      "There is too much connection with her and the audience in this Festival.",
      "Thank you so much for this performance",
      "Just amazing!! Best entertainer ever!! Just love her!!!",
      "Beyonce super powerfull, so awesome",
      "one of the best performances of ALL TIME.",
      "This will always be a Timeless moment for Glastonbury.",
      "Love, love, love!",
      "Amazing BEYONCE!!!",
      "Perfect vocals",
